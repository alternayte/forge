...
Status: Complete
Last activity: 2026-02-19 - Completed Phase 09 Plan 05: forge generate main.go scaffold-once and forge dev auto-migrate
...
| Phase 09 P04 | 1 | 2 tasks | 4 files |
| Phase 09 P05 | 2 | 2 tasks | 4 files |
...
- [Phase 09]: schema.go.tmpl hardcodes github.com/alternayte/forge/schema import — schema package is framework public API, not user module
- [Phase 09]: go.mod.tmpl uses v0.0.0 placeholder version — users add replace directive for local dev or pin release version
- [Phase 09]: main.go.tmpl is clean placeholder without forge-framework wiring — real server wiring generated by forge generate in Plan 05
- [Phase 09-05]: Scaffold-once detection uses bytes.Contains for 'forge.New'/'forge.LoadConfig' markers — simple, fast, unique to generated files
- [Phase 09-05]: ensureDatabase uses pgx directly (not exec createdb) to avoid external tool dependency in the dev watcher
- [Phase 09-05]: Auto-migrate is non-fatal in dev mode (warn and continue) — resilient dev loop over correctness enforcement
...
Stopped at: Completed 09-05-PLAN.md (Phase 9 complete — all 5 plans done)
